...
\centering
\begin{floatrow}
\ffigbox{\includegraphics[width=0.6\textwidth]{../img/body.png}}{\caption{Soubor bodů}}{\label{fig:soubor_bodu}}
\ffigbox{\includegraphics[width=0.6\textwidth]{../img/domain.png}}{\caption{Konvexní obal nad doménou $\Omega$ }}{\label{fig:domena}}
\end{floatrow}
\end{figure}
...
\centering
\begin{floatrow}
\ffigbox{\includegraphics[width=0.6\textwidth]{../img/minmax1.png}}{\caption{Případ1}}{\label{fig:neutral_case_1}}
\ffigbox{\includegraphics[width=0.6\textwidth]{../img/minmax2.png}}{\caption{Případ2}}{\label{fig:neutral_case_2}}
\end{floatrow}
\end{figure}
...
Voronoiovy diagramy úzce souvisí s Delaunayovou triangulací. Představme si opět množinu bodů $P = \{p_1,...p_N\} $ v prostoru a nechť je $d(p_i,p_j) $ Eukleidovská vzdálenost mezi body $p_i$ a $p_j$. Po té každému bodu $p_i$v množině $P$ přiřadíme takovou oblast, která splňuje následující podmínku: 

$V(p_i) = \{ x: d(x, p_i) < d(x, p_j), j = 1,...,N\}$.

Pro každou takovouto oblast přiřazenou bodu $p_i$ po té platí, že všechny body uvnitř této oblasti jsou k bodu $p_i$ blíž než ke kterémukoliv jinému bodu z množiny $P$ a takovouto oblast nazýváme \textit{Voronoiův polygon}.
