...
Na Obrázku \ref{fig:triangulace} už můžeme vidět validní a regulérní triangulaci. Jedná se též o triangulaci \emph{optimální}, což je termín, kterým se budeme zabývat v kapitole \ref{chap:Optim_trian}.

\newpage
\subsection{Optimální triangulace}
\label{chap:Optim_trian}
