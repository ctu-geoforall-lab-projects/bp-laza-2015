...
\begin{figure}[h!]
\centering
\includegraphics[width=0.9\textwidth]{img/podm_3.png}
\caption{Spojitá doména $\Omega$}
\label{fig:podm_1}
\end{figure}
\end{comment}
...
\centering
\begin{floatrow}
\ffigbox{\includegraphics[width=0.48\textwidth]{img/minmax2.png}}{\caption{Případ1}}{\label{fig:neutral_case_1}}
\ffigbox{\includegraphics[width=0.48\textwidth]{img/minmax1.png}}{\caption{Případ2}}{\label{fig:neutral_case_2}}
\end{floatrow}
\end{figure}
...
Z Obrázku \ref{fig:vor_pol} je vidět, že oblasti přiřazené pro body na okraji konvexního obalu nejsou zcela ohraničené a uzavřené. Jednotlivé hranice oblastí nazýváme \emph{Voronoiovi polygony}, které jsou složeny z takzvaných \emph{Voronoiových hran a bodů}. O dvou bodech $p_j$ a $p_k$ můžeme tvrdit, že jsou \emph{Voronoiovi sousedé}, pokud oblasti, kterým náleží, sdílí společnou \emph{Voronoiovu hranu}. 
...
\todo[inline]{Obrázek dělení na podmnožiny}
...
\todo[inline]{Vložit oskenovanou strukturu}
