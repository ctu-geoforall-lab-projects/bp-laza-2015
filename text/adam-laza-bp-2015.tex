...
\begin{abstract}
  ...
  knihovna používá knihovnu \emph{Triangle}, která nedovoluje
  ...
  mohl být tento interpolační nástroj zařazen do oficiální distribuce
...
%%% ML: upraveno na Esri ArcGIS - OK
  rychlosti a kvality výstupu mezi GRASS GIS a Esri ArcGIS.

\bigskip
%% ML: Voronoiovy diagramy (a ne polygony)
%% AL: To budu mit spatne v cele praci, pouzil jsem schvalne jednotne cislo
%% ML: ja nemyslel mluvnicke cislo, ale Vororoiuv diagram vs. Voronoiuv polygon
%% AL: to jsem prosel taky,polygon nahrazen za diagram
...
%% ML: jeste popros aby to nekdo prosel
%% AL: projito
  ...
  Add-Ons package, but this module is written in Bash and
...
%%% AL: pridany odkazy
%%% ML: chybi odkaz na dalsi kapitoly (Python)
%%% AL: pridany odkazy
%%% ML: OK
...
%%% ML: trosku vaham, lepsi by byl "shellovy skript", ale klidne nech puvodni formulaci "skript pro Bash", za to Ti nikdo hlavu neutrhne
...
%%% ML: OK (jenom se podivej, zda je to v celem textu prace)
...
%%% konzultace s Mayrem
%%% ML: jak to dopadlo?
%%% AL: ke konzultaci nedoslo, nasel jsem o tom nejake prameny na netu, moc tomu nerozumim,
%%% dal jsem sem jen par obecnych vet, ale nevim, zda tu nenechat jen tu linearni
%%% ML: OK, jenom se priprav, ze se Te na to nekdo muze zeptat
Profesor Gerald Farin přišel s mnohem obecnějším přístupem, který není omezen na souřadnice přirozených sousedů, ale může být použit pro všechny lokální souřadnice. Váha $\lambda$ může být vnímána jako barycentrická souřadnice v Bezierovu simplexu. Více zde: \cite{Bobach} \cite{CGAL}.
...
%%% ML: OK (pokud muzes mit cas a chut, tak tu legendu udelej trosku mensi)
%%% AL: zkousel jsem to, ale vubec nevim, jak to zmenit v cairu. Zatim jsem to nechal stejny.
%%% ML: zalezi jaky pouzivas prikaz pro renderovani.
\begin{figure}[h!]
\centering
...
%%% ML: To nejsou objekty, ale metody, resp. konstruktor a desktruktor
%%% AL: opraveno
%%% ML: OK
...
%%% ML: to nezni moc hezky, co treba "Tato trida ... data, rodičovskou třídou je Nnbathy" nebo treba prijdes na neco lepsiho
%%% ML: OK
...
%%% ML: dopln prosim jeste dnes pokud mozno
%%% AL: doplneno
%%% ML: OK
...
\centering
\begin{floatrow}
\ffigbox{\includegraphics[width=0.48\textwidth]{img/body_1000.png}}{\caption{ArcGIS: Výstupní rastr pro 1 000 bodů}}{\label{fig:b1000_Arc}}
\ffigbox{\includegraphics[width=0.48\textwidth]{img/body_1000_grass.png}}{\caption{GRASS GIS, v.surf.nnbathy: Výstupní rastr pro 1 000 bodů}}{\label{fig:b1000_grass}}
\end{floatrow}
\end{figure}
...
\caption{GRASS GIS, v.surf.nn: Výstupní rastr pro 1 000 bodů}
\label{fig:b1000_nn}
\end{figure}

%%% ML: temhle obrazku nerozumim: to je rozdil mezi v.surf.nn (CGAL) a
%%% ArcGIS (u v.surf.nnbathy jsi rikal, ze rozdil neni)
\newpage
\begin{figure}[h!]
\centering
\begin{floatrow}
\ffigbox{\includegraphics[width=0.48\textwidth]{img/body_100000.png}}{\caption{ArcGIS: Výstupní rastr pro 100 000 bodů}}{\label{fig:b100000_Arc}}
\ffigbox{\includegraphics[width=0.48\textwidth]{img/body_100000_grass.png}}{\caption{GRASS GIS, 
v.surf.nn.bathy: Výstupní rastr pro 100 000 bodů}}{\label{fig:b100000_grass}}
\end{floatrow}
\end{figure}
...
\centering
\begin{floatrow}
\ffigbox{\includegraphics[width=0.48\textwidth]{img/body_mil.png}}{\caption{ArcGIS: Výstupní rastr pro 1 000 000 bodů}}{\label{fig:b_mil_Arc}}
\ffigbox{\includegraphics[width=0.48\textwidth]{img/body_mil_grass.png}}{\caption{GRASS GIS, v.surf.nnbathy: Výstupní rastr pro 1 000 000 bodů}}{\label{fig:b_mil_grass}}
\end{floatrow}
\end{figure}
...
\centering
\begin{floatrow}
\ffigbox{\includegraphics[width=0.48\textwidth]{img/diff_1000.png}}{\caption{Rozdíl mezi výstupem GRASS GISu (v.surf.nnbathy) a Arc GISu pro 1 000 bodů}}{\label{fig:diff_1000}}
\ffigbox{\includegraphics[width=0.48\textwidth]{img/diff_100000.png}}{\caption{Rozdíl mezi výstupem GRASS GISu (v.surf.nnbathy) a Arc GISu pro 100 000 bodů}}{\label{fig:dif_100000}}
\end{floatrow}
\end{figure}
...
%%% ML: jeste to projdu, zatim to takto nech
...
%%% AL: doplneno
%%% ML: OK
%%% AL: nejsem si jisty, zda je na tom CD takhle vsechno, co tam ma byt
%%% ML: jeste bych tam pridal testovaci data a vsechny skript, tak aby to bylo reprodukovatelne
